...
var logger = log4js.getLogger('teco');
logger.level = 'DEBUG';
...
var nwConfig = path.resolve(__dirname, './network-config.json');
var ORGS = JSON.parse(fs.readFileSync(nwConfig, 'utf8'));
ORGS = ORGS["network-config"];
...
//             let channel = client.getChannel('ecsupply');
